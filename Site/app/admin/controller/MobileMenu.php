...
use app\common\logic\admin\MobileMenu as MobileMenuLogic;
use app\common\validate\admin\Ads as AdsValidate;
...
class MobileMenu extends Base
{
    ...
    {
        return $this->fetch('/mobile_menu_add');
    }
    ...
    {
        $logic = new MobileMenuLogic();
        $data = $logic->readData($id);
        if (!empty($data)) {
            $this->assign('data', $data);
            return $this->fetch('/mobile_menu_edit');
        }
        else {
