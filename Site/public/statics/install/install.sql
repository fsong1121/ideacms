...
CREATE TABLE `{PREFIX}bill` (
  ...
  `tax_pic` varchar(100) DEFAULT NULL COMMENT '发票图片',
...
CREATE TABLE `{PREFIX}goods` (
  ...
  `stock` smallint(6) unsigned DEFAULT '0' COMMENT '库存',
...
DROP TABLE IF EXISTS `{PREFIX}miniapp_user`;
CREATE TABLE `{PREFIX}miniapp_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '序号',
  `openid` varchar(50) DEFAULT NULL COMMENT 'openID',
  `unionid` varchar(50) DEFAULT NULL COMMENT 'unionID',
  `nickname` varchar(50) DEFAULT NULL COMMENT '昵称',
  `avatar` varchar(200) DEFAULT NULL COMMENT '头像',
  `add_date` int(10) unsigned DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='小程序会员';
...
CREATE TABLE `{PREFIX}user` (
  ...
  `wechat_user_id` int(10) unsigned DEFAULT '0' COMMENT '微信会员ID',
  `miniapp_user_id` int(10) unsigned DEFAULT '0' COMMENT '小程序会员ID',
...
DROP TABLE IF EXISTS `{PREFIX}wechat_user`;
CREATE TABLE `{PREFIX}wechat_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '序号',
  `openid` varchar(50) DEFAULT NULL COMMENT 'openID',
  `unionid` varchar(50) DEFAULT NULL COMMENT 'unionID',
  `nickname` varchar(50) DEFAULT NULL COMMENT '昵称',
  ...
  `add_date` int(10) unsigned DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='公众号会员';
